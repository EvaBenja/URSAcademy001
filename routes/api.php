...
use App\Http\Controllers\BoutiqueVendeurController;
...
// Boutique vendeur publique — sans authentification
Route::get('/boutique/{code}',           [BoutiqueVendeurController::class, 'boutiquePub']);
Route::post('/boutique/{code}/commander',[BoutiqueVendeurController::class, 'commander']);

// Webhook Shopify — DOIT être public (pas de token)
Route::post('/shopify/webhook/orders',   [ShopifyController::class, 'webhookOrders']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('/ventes/{id}',          [VenteController::class, 'supprimer']);
    ...
    // Boutique personnalisée vendeur
    Route::get('/mon-lien',                         [BoutiqueVendeurController::class, 'monLien']);
    Route::put('/ma-boutique',                      [BoutiqueVendeurController::class, 'updateBoutique']);
    Route::get('/ma-boutique/stats',                [BoutiqueVendeurController::class, 'mesBoutiqueStats']);

    // Closing Shopify
    Route::get('/closing',                          [ShopifyController::class, 'index']);
    Route::get('/closing/stats',                    [ShopifyController::class, 'stats']);
    Route::post('/closing/{id}/prendre',            [ShopifyController::class, 'prendreCommande']);
    Route::post('/closing/{id}/traiter',            [ShopifyController::class, 'traiterCommande']);

    // Répartition financière
    Route::get('/finance/media-buying',             [RepartitionController::class, 'mediaBuying']);
    Route::post('/finance/media-buying/deduire',    [RepartitionController::class, 'deduireMediaBuying']);
    Route::get('/finance/budget-stock',             [RepartitionController::class, 'budgetStock']);
    Route::post('/finance/budget-stock/deduire',    [RepartitionController::class, 'deduireBudgetStock']);
    Route::get('/finance/benefices',                [RepartitionController::class, 'benefices']);
